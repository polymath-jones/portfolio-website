          ...
          <div className="flex flex-col  md:grid min-h-[700px] md:h-[750px] overflow-hidden grid-cols-2 rounded-[20px] mt-7.5 md:mt-[70px]">
            ...
            >
              <div className="flex items-center">
                <div className="text-white font-display2 bg-black z-20 pr-7.5 text-4xl md:text-5xl flex flex-col space-y-[-10px]">
            ...
            <div className="overflow-hidden flex-1 p-7.5 md:p-12.5 bg-white relative cursor-pointer">
              <div className="flex items-center">
                <div className="text-black  bg-white z-20 pr-7.5 text-4xl md:text-5xl flex flex-col space-y-[-7px]">
                  ...
                  <h1 className="animate__animated animate__fadeInUp !delay-1000 !duration-700 font-display tracking-tighter font-medium">
                    <span className="opacity-50">Page</span>
                  </h1>
                </div>
