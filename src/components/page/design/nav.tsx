  ...
  return (
    <div className="pt-10 sm:pt-[65px] flex justify-between sm:items-center ">
      ...
      <div className="flex flex-col sm:flex-row gap-1.25 sm:items-center">
        {linkData.map((l, i) => (
          <button key={i} style={{animationDelay: `${i*200 + 7000}ms !important`}} className="animate__animated animate__fadeIn !duration-600 sm:text-sm text-xs justify-center flex items-center h-[33px] text-white hover:border-outline-dark border border-outline-black rounded-full gap-2.5 p-2.5 font-body">
