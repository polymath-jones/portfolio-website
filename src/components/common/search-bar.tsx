...
const SearchBar: React.FC<Props> = ({
  ...
  return (
    <div className={`max-w-[400px] ${className} ${disabled && "opacity-60"}`}>
      <div className={`h-10 w-full relative flex items-center font-action`}>
        <input
          {...props}
          disabled={disabled}
          placeholder={label}
        ...
        />
        <button className="px-5 py-3 bg-primary-400 rounded-tr-lg rounded-br-lg border border-primary-400 -ml-2">
          {/* prettier-ignore */}
